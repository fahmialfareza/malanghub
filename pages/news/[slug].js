              ...
              <div className="container mt-md-3">
                ...
                <div className="blog-post-align">
                  <div className="blog-post-img embed-responsive embed-responsive-1by1">
                    {currentNews?.user && (
                      <Link href={`/users/${currentNews.user._id}`} legacyBehavior>
                        <img
                          src={
                            currentNews &&
                            currentNews.user &&
                  ...
                  <div className="blog-post-info">
                    <div className="author align-items-center mb-1">
                      ...
                      {currentNews?.category && (
                        <Link href={`/newsCategories/${currentNews?.category?.slug}`} legacyBehavior>
                      ...
                      <div className="buttons-singles tags">
                        ...
                        {currentNews?.tags &&
                          currentNews.tags.map((tag) => (
                            <Link key={tag._id} href={`/newsTags/${tag.slug}`} legacyBehavior>
                              {tag.name}
                            </Link>
                          ))}
                      </div>
