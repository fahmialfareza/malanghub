...
export async function getServerSideProps({ params }) {
  ...
  let configTrending = {
    method: "get",
    url: `${process.env.NEXT_PUBLIC_API_ADDRESS}/api/news?page=1&sort=-views&limit=4&user=${id}`,
  };

  let configUser = {
    method: "get",
    url: `${process.env.NEXT_PUBLIC_API_ADDRESS}/api/users/${id}`,
  };
