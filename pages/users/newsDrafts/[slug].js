                  ...
                  <div className="blog-post-img embed-responsive embed-responsive-1by1">
                    {newsDraftLoading ? (
                      ...
                      currentNewsDraft.user && (
                        <Link href={`/users/${currentNewsDraft.user._id}`} legacyBehavior>
                          <img
                            src={
                              currentNewsDraft &&
                              currentNewsDraft.user &&
                    ...
                    <div className="author align-items-center mb-1">
                      ...
                      {currentNewsDraft &&
                        ...
                        currentNewsDraft.category._id && (
                          <Link href={`/newsCategories/${currentNewsDraft.category._id}`} legacyBehavior>
                            {newsDraftLoading ? (
                              <Spinner />
                            ) : (
                              currentNewsDraft &&
                      ...
                      <div className="buttons-singles tags">
                        ...
                        {newsDraftLoading ? (
                          ...
                          currentNewsDraft.tags.map((tag) => (
                            <Link key={tag._id} href={`/newsTags/${tag._id}`} legacyBehavior>
                              {tag.name}
                            </Link>
                          ))
                        )}
